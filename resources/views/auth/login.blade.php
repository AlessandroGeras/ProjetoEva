            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                <form method="POST" action="{{route('autenticar')}}">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/auth/register">
                            Cadastrar novo usuário
                        </a>

                        <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/auth/forgot-password">
                            Esqueceu a senha?
                        </a>
