<div class="sticky top-[100vh] w-full h-[525px] bg-zinc-900 text-white sm:h-72 dark:text-gray-200 dark:bg-black">
  <div class="grid center grid-cols-1 gap-y-6 sm:grid-cols-3">
    <div class="m-auto text-center">
      ...
      <div class="text-xs lg:text-sm">R. Victor Carlos Nauck, 1023 <br>
        Garopaba - SC <br><br>
        (48) 99937-8166
      </div>
    </div>
    <div class="text-xs lg:text-sm m-auto text-center">
      ...
      quintas 14:00–21:00 <br>
      sextas Fechado <br>
      sábados Fechado <br>
      domingos Fechado <br>
    </div>
    <div class="text-xs lg:text-sm m-auto text-center">
      <div class="pb-2.5">Cadastre-se no nosso <br>
        grupo de WhatsApp para <br>
        receber novidades <br>
        clicando no link abaixo <br>
        ou usando o QR Code
      </div>
      <a href="https://chat.whatsapp.com/CbXwuWvcpur9c4bPs563Lq" class="underline">Cadastrar</a> <br>
