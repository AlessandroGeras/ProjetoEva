...
const menu_click = (clicked_id) => {
    if (clicked_id == "menu_open") {
        ...
        navbar_menu.className =
            "mobile_open w-full h-full block bg-blue-500 float-left lg:float-right lg:w-[700px] lg:bg-transparent";
        ...
        let navbar_menu = document.getElementById("navbar_menu");
        navbar_menu.className =
            "mobile_close w-full h-full block bg-blue-500 float-left lg:float-right lg:w-[700px] lg:bg-transparent";
